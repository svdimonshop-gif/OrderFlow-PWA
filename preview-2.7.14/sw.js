...
// Bump this on every deploy. Cache names are scoped so a preview service worker
// cannot clear or replace the installed production PWA cache.
const CACHE_VERSION = '2.7.14-20';
